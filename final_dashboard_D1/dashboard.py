                        ...
                        html.Div(
                            [
                               html.Div(
                                ...
                                html.Div(
                                    [html.H6(id="Top5newoccurring"), html.P([html.B("Top newly occurring NPS")]), dash_dangerously_set_inner_html.DangerouslySetInnerHTML(get_newly_occurring_nps(nps_df, count = 5, days = 90))],
                                    id="top5new",
                                    className="mini_container",
                                ),
                            ],
